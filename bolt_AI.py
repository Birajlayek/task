    ...
    for filename in os.listdir(directory_path):
        if filename.endswith(".jpg") or filename.endswith(".png"):
            ...
            if image is not None:
                ...
                processed_image, cluster_count = draw_labels(image, class_ids, confidences, boxes, classes)
...
directory_path = '/Users/birajlayek1230/Desktop/task/CountingChallenge/Bolts'
